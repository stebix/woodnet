...
class ResNet18(torch.torch.nn.Module):
    """
    Core planar 2D ResNet model.
    Adaptation to triaxial workflows via channel adjustments.
    ...
    conv_1_channels : int
        Class variable. Number of channels in the first convolution.

    channel_cascade : list[int]
        Class variable. List of channel counts for the ResNet layers.
