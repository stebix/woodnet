"""
Toolkit to programmatically build transformation instances from
configuration dirctionaries.
...
def get_class(name: str) -> Type[torch.nn.Module]:
    ...
    for module in modules:
        try:
            ...
            continue
    raise ConfigurationError(f'could not find transform class with name "{name}"')
